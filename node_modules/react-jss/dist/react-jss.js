(function (global, factory) {
...
}(this, function (exports, React, defaultJss) { 'use strict';

  var React__default = 'default' in React ? React['default'] : React;
  var defaultJss__default = 'default' in defaultJss ? defaultJss['default'] : defaultJss;
  ...
  */
  ...
  var ReactIs = getCjsExportFromNamespace(reactIs$1);
  ...
  function functionPlugin() {
    return {
      onCreateRule: function onCreateRule(name, decl, options) {
        ...
        var rule = defaultJss.createRule(name, {}, options);
        rule[fnRuleNs] = decl;
        return rule;
      },
  ...
  function observablePlugin(updateOptions) {
    return {
      onCreateRule: function onCreateRule(name, decl, options) {
        ...
        var style$ = decl;
        var rule = defaultJss.createRule(name, {}, options); // TODO
  ...
  function () {
    function GlobalContainerRule(key, styles, options) {
      ...
      this.rules = new defaultJss.RuleList(_extends({}, options, {
        parent: this
      }));
  ...
  var px = defaultJss.hasCSSTOMSupport && CSS ? CSS.px : 'px';
  var ms = defaultJss.hasCSSTOMSupport && CSS ? CSS.ms : 'ms';
  var percent = defaultJss.hasCSSTOMSupport && CSS ? CSS.percent : '%';
  /**
  ...
  function jssVendorPrefixer() {
    ...
    function prefixStyle(style) {
      for (var prop in style) {
        ...
        var supportedValue$$1 = supportedValue(supportedProp, defaultJss.toCssValue(value));
    ...
    function onChangeValue(value, prop) {
      return supportedValue(prop, defaultJss.toCssValue(value)) || value;
    }
  ...
  var defaultJss$1 = defaultJss.create(index$1());
  ...
  var createUseStyles = function createUseStyles(styles, options) {
    ...
    var useTheme$$1 = typeof styles === 'function' ? // $FlowFixMe
    function () {
...

  {
    ...
    // http://fb.me/prop-types-in-prod
    var throwOnDirectAccess = true;
    module.exports = factoryWithTypeCheckers$1(ReactIs$$1.isElement, throwOnDirectAccess);
  }
  });
  ...
  JssProvider.propTypes = {
    registry: propTypes$1.instanceOf(defaultJss.SheetsRegistry),
    jss: propTypes$1.instanceOf(defaultJss__default.constructor),
  ...
  var defaultJss$2 = defaultJss.create(index$1());
