...
export declare const ProgressBarContainer: ({ percentage, fillerExtraStyles, progressBarExtraStyles, tooltip, onPercentageChange, tooltipStyle, }: ProgressBarContainerProps) => JSX_2.Element | null;
